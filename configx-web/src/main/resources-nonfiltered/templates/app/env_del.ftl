<!-- Modal -->
<div class="modal fade" id="delEnvModal" tabindex="-1" role="dialog" aria-labelledby="delete env">
            ...
            <div class="modal-body">
                <form class="form-horizontal" action="" method="post"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <p class="form-control-static" name="env-name"></p>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label">警告！</label>
                        <div class="col-sm-10">
                            <p class="form-control-static">您真的要删除这个环境吗？</p>
                        </div>
                    </div>
                    <div class="form-group">
