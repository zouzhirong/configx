<!-- Modal -->
<div class="modal fade" id="editProfileModal" tabindex="-1" role="dialog" aria-labelledby="edit profile">
    <div class="modal-dialog modal-lg" role="document" aria-hidden="true">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title">修改Profile</h4>
            </div>
            ...
            <div class="modal-body">
                <form class="form-horizontal" action="" method="post"
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Profile ID</label>
                        <div class="col-sm-10">
                            <p class="form-control-static" name="profile-id"></p>
                        </div>
                    </div>
                    <div class="form-group">
