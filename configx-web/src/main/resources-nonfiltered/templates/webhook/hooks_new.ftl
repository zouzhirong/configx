        ...
        <div class="container">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <div class="row">
                        <div class="col-md-12">
                            <h5><a href="/apps/${app.id}/hooks">Webhooks</a> / Add webhook</h5>
                        </div>
                    </div>
                </div>

                <div class="panel-body">
                    <form class="form-horizontal" action="/apps/${app.id}/hooks/add" method="post">
                        <div class="form-group">
                            <label for="name" class="col-md-2 control-label">钩子名称</label>
                            <div class="col-md-10">
                                <input type="text" class="form-control" size="40" id="name" name="name" placeholder="">
                            </div>
                        </div>
                        <div class="form-group">
                                ...
                                <select class="form-control" id="hook_event_type" name="eventType"
                                    ...
                                    <#list eventTypes as item>
                                        <option value="${item.type}"
                                                <#if item.type==eventType.type>selected="selected"</#if>>${item.typeName}</option>
                                    </#list>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <div class="panel panel-default">
                                    <div class="panel-body">
                                        <#list eventParamNames as eventParamName>
                                            <div class="row">
                                                ...
                                                <div class="col-md-6" style="height:34px; line-height: 34px">
                                                    <p class="text-muted"> ${MessageUtils.getMessage("event_type."+eventType.typeName+".event_param."+eventParamName)}</p>
                                                </div>
                                            </div>
                                            <p/>
                                        </#list>
                            ...
                            <div class="col-md-10">
                                <select class="form-control" id="hook_content_type" name="contentType">
                                    <#list contentTypes as item>
                                        <option value="${item.simpleType}">${item.fullType}</option>
                                    </#list>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <div class="panel panel-default">
                                    <div class="panel-body">
                                        <#list requestParamNames as requestParamName>
                                            <div class="row">
                                                <div class="col-md-2" style="height:34px; line-height: 34px">
                                                ...
                                                <div class="col-md-6" style="height:34px; line-height: 34px">
                                                    <p class="text-muted"> ${MessageUtils.getMessage("event_type."+eventType.typeName+".webhook_param."+requestParamName)}</p>
                                                </div>
                                            </div>
                                            <p/>
                                        </#list>
                        ...
                        <div class="form-group">
                            <div class="col-md-offset-2 col-md-10">
                                <button type="submit" class="btn btn-default">添加Webhook</button>
                            </div>
                        </div>
                    </form>
                </div>
