...
import com.configx.client.properties.ConfigurationBeanFactoryMetaData;
 ...
 * @author Zhirong Zou
 */
public class RefreshableBeanDependencyManagement implements InstantiationAwareBeanPostProcessor, PriorityOrdered {
    ...
    private void resolveDependencyForRefreshBeanDependencyBeans(Object bean, String beanName) {
        if (bean.getClass().equals(RefreshableBeanDependency.class)) {
            RefreshableBeanDependency refreshBean = (RefreshableBeanDependency) bean;
